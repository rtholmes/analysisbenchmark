...
public class ValidateNestedClass extends AbstractValidation {
	...
	public void checkClass() {
		...
		//This will be fixed tomorrow see issue #24 incorrect parsing of inner classes
		// static
	...
	public void checkFields() {
		...
		Assert.assertEquals(Ids.NestedClass_nestedInitializedStringVector, _staticModel.getField(Ids.NestedClass_nestedInitializedStringVector).getId());
